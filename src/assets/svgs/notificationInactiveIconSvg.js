...
const NotificationInactiveIconSvg = props => (
  <Svg
    ...
    <Path
      ...
      strokeMiterlimit={10}
      strokeWidth={1.5}
      d="M13.872 3.2a6.754 6.754 0 0 0-3.7 0c.29-.74 1.01-1.26 1.85-1.26.84 0 1.56.52 1.85 1.26v0Z"
    />
    <Path
      stroke="#2F3A4E"
      strokeMiterlimit={10}
...
export default NotificationInactiveIconSvg;
