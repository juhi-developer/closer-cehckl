...
export default function DeleteAccountPartnerSideModal(props) {
  ...
  const onDismiss = async () => {
    await updateContextualTooltipState('deleteAccountPartnerModalShown', true);
    ...
    <Modal
      ...
      <View
        ...
        <Text
          ...
          {`We’re sorry to share that ${VARIABLES.user?.partnerData?.partner?.name} has deleted their Closer account.  While you can view the app, you will not be able to perform any activity, and there will be no new quiz cards or any other activity on the app.`}
        </Text>
        ...
        <Pressable
          ...
          <Text style={styles.textButton}>Yes, log out</Text>
        </Pressable>
