    ...
    <Modal
      ...
      <View
        ...
        <Text
          ...
          You might lose all data that isn’t backed up, when you log back in.
          Please check the time of the last backup from your profile, or tap on
          ‘Back up now’ to take the latest backup.
        </Text>
